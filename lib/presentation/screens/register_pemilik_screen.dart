...
class _RegisterPemilikScreenState extends State<RegisterPemilikScreen> {
  ...
  void _handleRegister() async {
    ...
    bool success = await authProvider.registerPemilik(
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Akun Pemilik Kos berhasil dibuat!'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Daftar Akun Pemilik Kos',
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text('Buat Akun Pemilik',
                    style: Theme.of(context).textTheme.headlineSmall?.copyWith(
                        color: Colors.white,
                        fontSize: 24,
                        fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text('Kelola dan pasang iklan kos Anda di KostGo',
